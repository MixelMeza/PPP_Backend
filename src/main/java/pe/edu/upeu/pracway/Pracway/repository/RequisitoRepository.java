...
public interface RequisitoRepository extends JpaRepository<Requisito, Long>{
    ...
    void insertarRequisito(String p_n_orden, String p_nombre, String p_tipo, String p_estado);

    @Procedure(procedureName = "sp_editar_requisito")
    void actualizarRequisito(Long p_id, String p_n_orden, String p_nombre, String p_tipo, String p_estado);
